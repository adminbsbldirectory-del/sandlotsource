      ...
      <div className="empty-state" style={{ gridColumn:'1/-1' }}>
        <h3>
          {hasFilters
            ...
            : 'No teams listed yet' + (selectedState ? ' in ' + selectedState.name : '')}
        </h3>
        <p>
          {geoCenter
    ...
    <div>
        ...
        <TeamProfile
          ...
          onClaim={(team) => {
            window.location.href =
              'mailto:admin.bsbldirectory@gmail.com?subject=Claim Request: ' +
      ...
      <div className="filter-bar" style={{ zIndex:500 }}>
        <div style={{ display:'flex', alignItems:'center', gap:6 }}>
          <label style={{ fontSize:12, fontWeight:600, color:'var(--navy)', whiteSpace:'nowrap' }}>
            State
          </label>
          <select
            value={state}
        ...
        >
          ...
          {zip.length === 5 && (
            <>
              ...
              />
              <span style={{ fontSize:12, fontWeight:600, color:'var(--navy)', minWidth:34 }}>
                {radius} mi
              </span>
            </>
          )}
      ...
      {state && filtered.some((t) => t.tryout_status === 'open') && (
        <div
          style={{
            background:'var(--open-bg)',
            borderBottom:'2px solid var(--open-text)',
            padding:'10px 20px',
            fontSize:13,
            color:'var(--open-text)',
            fontWeight:600,
        ...
        >
          {'✅ ' +
            filtered.filter((t) => t.tryout_status === 'open').length +
            ' team' +
            (filtered.filter((t) => t.tryout_status === 'open').length !== 1 ? 's' : '') +
            ' currently accepting tryouts' +
            (selectedState ? ' in ' + selectedState.name : '')}
        </div>
      )}
