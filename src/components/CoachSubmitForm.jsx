...
const AGE_GROUPS = [
  '6U','7U','8U','9U','10U','11U','12U','13U','14U','15U','16U','17U','18U','High School','College','Adult',
]
    ...
    <div>
      <div className="form-section">
        ...
        >
          <div>
            <label style={labelStyle}>
              Coach / Trainer Name <RequiredMark />
            </label>
            <input
              value={form.name}
          ...
          <div>
            <label style={labelStyle}>
              Facility / Business Name <RequiredMark />
            </label>
            <input
      ...
      <div className="form-section">
        ...
        >
          <div>
            <label style={labelStyle}>
              Email <RequiredMark />{' '}
              <span style={{ fontWeight: 400, textTransform: 'none' }}>(or phone)</span>
            </label>
            <input
              type="email"
              value={form.email}
      ...
      <div style={{ fontSize: 11, color: 'var(--gray)', marginBottom: 12 }}>
        All listings are reviewed before going live. Fields marked{' '}
...
function TeamForm() {
  ...
  if (submitted) {
    return (
      <SuccessBanner message="Your travel team has been submitted for review. We'll have it live within a few days." />
    )
  }
        ...
        >
          <div>
            ...
            <input
              value={form.name}
              onChange={(e) => set('name', e.target.value)}
              placeholder="e.g. Cherokee Nationals 12U"
              style={inputStyle}
            />
          </div>
          <div>
      ...
      <div className="form-section">
        ...
        >
          <div>
            ...
            <select
              ...
              onChange={(e) => set('tryout_status', e.target.value)}
              style={selectStyle}
            >
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <input
            ...
            onChange={(e) => set('tryout_notes', e.target.value)}
...
function PlayerForm() {
  ...
  if (submitted) {
    return (
      <SuccessBanner message="Your post has been submitted and will appear on the Player Board once reviewed. Posts expire in 4 days." />
    )
  }
        ...
        <>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <input
              ...
              placeholder="e.g. Wills Park Field 3, Seckinger High School"
              style={inputStyle}
            />
            <div style={{ fontSize: 11, color: '#888', marginTop: 3 }}>
              This location name is used to place the map pin precisely
            </div>
          </div>
          ...
          <div style={{ marginBottom: 14 }}>
            <ZipField
              ...
              onGeocode={handleGeocode}
              required
              hint="Area zip for search radius matching"
            />
          </div>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Practice schedule, skill level expected, tryout info..."
              style={textareaStyle}
            />
          </div>
        </>
        ...
        <>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <textarea
              ...
              onChange={(e) => set('player_description', e.target.value)}
              rows={3}
              placeholder="Age, skill level, what you're looking for in a team..."
              style={textareaStyle}
            />
          </div>
...
function FacilityForm() {
  ...
  if (submitted) {
    return (
      <SuccessBanner message="Your facility has been submitted for review. We'll have it live within a few days." />
    )
  }
    ...
    <div>
      <div className="form-section">
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          />
          <div style={{ fontSize: 11, color: '#888', marginTop: 3 }}>
            Enter address then tab out to place an accurate map pin
          </div>
        </div>
