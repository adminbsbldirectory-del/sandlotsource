...
import RosterSubmittedState from './rosterspots/RosterSubmittedState.jsx'
import RosterBrowseContent from './rosterspots/RosterBrowseContent.jsx'
...
export default function RosterSpots() {
  ...
  if (view === 'submitted') {
    return (
      <RosterSubmittedState
        submittedInfo={submittedInfo}
        onBackToRosterSpots={() => setView('browse')}
      />
    )
  }
  ...
  <RosterBrowseContent
    ...
    InlineMobileAdSlot={InlineMobileAdSlot}
    FitBounds={FitBounds}
    makeIcon={makeIcon}
    PIN_COLOR={PIN_COLOR}
  />
