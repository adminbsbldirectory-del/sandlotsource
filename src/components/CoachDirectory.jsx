...
const DEMO_COACHES = [
  {
    ...
    state: 'GA',
    zip: '30341',
    facility_name: 'El Dojo',
    lat: 33.888,
    lng: -84.299,
    credentials: 'Elite catching coach',
    price_notes: '1.5 hr sessions',
    recommendation_count: 5,
  },
  {
    id: 2,
    name: 'Cristoforo Romano',
    sport: 'baseball',
    specialty: ['Pitching'],
    city: 'Marietta',
    state: 'GA',
    zip: '30062',
    facility_name: 'Harrison Park',
    lat: 33.961,
    lng: -84.548,
    credentials: 'Former Detroit Tigers & Brewers MiLB coach; Masters Biomechanics',
    price_per_session: 70,
    price_notes: '$70 cash / $80 Venmo',
    recommendation_count: 8,
  },
  {
    id: 3,
    name: 'Chris Bootcheck',
    sport: 'baseball',
    specialty: ['Pitching'],
    city: 'Woodstock',
    state: 'GA',
    zip: '30189',
    facility_name: 'Auterson Baseball (The Hive)',
    lat: 34.101,
    lng: -84.519,
    credentials: 'Former MLB pitcher',
    recommendation_count: 6,
  },
  {
    id: 4,
    name: 'Jagger Iovinelli',
    sport: 'baseball',
    specialty: ['Pitching'],
    city: 'Alpharetta',
    state: 'GA',
    zip: '30004',
    facility_name: 'Grit Academy Athletics',
    lat: 34.075,
    lng: -84.294,
  ...
  },
  {
    ...
    state: 'GA',
    zip: '30519',
    facility_name: 'WC19 Pro Hit',
    lat: 34.119,
    lng: -83.991,
    credentials: 'Former Atlanta Brave',
    recommendation_count: 3,
  },
  {
    id: 6,
    name: 'Hannah Lane Triplett',
    sport: 'softball',
    specialty: ['Pitching'],
    city: 'Watkinsville',
    state: 'GA',
    zip: '30677',
    facility_name: 'Della Torre Softball',
    lat: 33.858,
    lng: -83.416,
    credentials: 'Top-tier softball pitching',
  ...
  },
  {
    ...
    lat: 34.237,
    lng: -84.491,
    credentials: '10+ years; 4 years college baseball',
    recommendation_count: 3,
  },
]
...
function RatingRow({ coach, selected }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginTop: 6, fontSize: 13 }}>
      ...
      <span style={{ fontWeight: 700, color: selected ? 'var(--gold)' : 'var(--navy)' }}>
        {avg.toFixed(1)}
      </span>
